...
func TestAgentsWidget_RunningPriorityWithMaxDisplay(t *testing.T) {
	...
	// Only 2 agents should be shown
	if strings.Contains(result, "Explore") && strings.Contains(result, "general-purpose") {
		t.Errorf("Expected at most 2 agents, got '%s'", result)
	}
}
